      ...
      <el-row class="rec_file" id="jieshou">
        ...
        <div class="kuang">
          ...
          <div class="kuang4">
            ...
            <div class="kuang42">
              <li
                v-bind="form.lingdaopishilist"
                v-for="item in form.lingdaopishilist"
                :key="item.time"
              >
          ...
          <div class="kuang4">
            ...
            <div class="kuang42">
              <li v-bind="form.qianyuelist" v-for="item in form.qianyuelist" :key="item">
