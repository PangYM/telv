    ...
    <el-col :span="23" class="warpmain">
      <el-form label-width="80px">
        <el-form-item label="我的签名">
          <el-upload class="uploader" ref="upload" :action="qianmingUrl" :show-file-list="false" :data="token" list-type="picture-card" :before-upload="beforeAvatarUpload">
  ...
  export default {
    ...
    methods: {
      ...
      handleSaveProfile() {
        ...
        API.setqianmingUrl(this.token).then(({
        data
      }) => {
        this.imageUrl = API.base+'/data/'+data.qianmingUrl;
      });
