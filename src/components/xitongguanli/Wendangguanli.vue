<template>
  <div class="oa_main">
    ...
    <div class="chaxun">
      <el-input class="chaxun1" size="medium" v-model="wendangid" placeholder="请输入文档编号" @keyup.enter.native="chaxun"></el-input>
      <el-button size="medium" type="primary" @click="chaxun">查询</el-button>
    </div>
    <el-table border :data="dataTable" stripe style="width: 100%" :default-sort = "{prop: 'laiwentime', order: 'descending'}">
      <el-table-column sortable prop="biaoti" align="center" label="标题" show-overflow-tooltip min-width="200">
      </el-table-column>
      <el-table-column sortable prop="nigaoren" align="center" label="发文人" show-overflow-tooltip width="108">
      </el-table-column>
