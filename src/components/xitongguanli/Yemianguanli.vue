...
<template slot-scope="scope">
  <el-button size="mini" style="margin-bottom:20px;" v-if="scope.row.show==0" @click="xianshireirong(scope.$index, scope.row,1)">
    显示内容</el-button>
  <el-button size="mini" style="margin-bottom:20px;" v-else @click="xianshireirong(scope.$index, scope.row,0)">隐藏内容</el-button>
  <vue-editor v-if="scope.row.show==1" style="height:1000px;" useCustomImageHandler @imageAdded="handleImageAdded" v-model="scope.row.content"></vue-editor>
</template>
          </el-table-column>
          <el-table-column label="操作" align="center" width="150">
<template slot-scope="scope">
  <el-button size="small" icon="el-icon-minus" @click="handleRemoveTask0(scope.$index)">
  </el-button>
  <el-button size="small" icon="el-icon-plus" @click="handleAddTask0()" v-if="scope.$index == dengluyelist.length - 1"></el-button>
</template>
          </el-table-column>
        </el-table>
...
<template slot-scope="scope">
  ...
  <div>
    <el-upload class="upload-demo" :action="lunbotuUrl" :data="uploadlist[scope.$index]" :on-success="onsuccess" :before-upload="beforeAvatarUpload" :show-file-list="false">
      <el-button size="small" type="primary">点击上传</el-button>
          ...
          <el-table-column prop="content" label="内容" align="center">
<template slot-scope="scope">
  <el-button size="mini" style="margin-bottom:20px;" v-if="scope.row.show==0" @click="xianshireirong1(scope.$index, scope.row,1)">
    显示内容</el-button>
  ...
  <vue-editor v-if="scope.row.show==1" style="height:1000px;" useCustomImageHandler @imageAdded="handleImageAdded" v-model="scope.row.content"></vue-editor>
          ...
          <el-table-column label="操作" align="center" width="150">
<template slot-scope="scope">
  <el-button size="small" icon="el-icon-minus" @click="handleRemoveTask1(scope.$index)">
  </el-button>
  <el-button size="small" icon="el-icon-plus" @click="handleAddTask1()" v-if="scope.$index == lunbotulist.length - 1"></el-button>
</template>
          </el-table-column>
        </el-table>
...
<template slot-scope="scope">
  <el-input v-model="scope.row.title" placeholder="请输入网址名称">
  </el-input>
</template>
          </el-table-column>
          <el-table-column prop="url" label="网址" align="center" width="300">
<template slot-scope="scope">
  <el-input v-model="scope.row.url" placeholder="请输入网址">
  </el-input>
</template>
          </el-table-column>
          <el-table-column label="操作" align="center" width="150">
<template slot-scope="scope">
  <el-button size="small" icon="el-icon-minus" @click="handleRemoveTask2(scope.$index)">
  </el-button>
  <el-button size="small" icon="el-icon-plus" @click="handleAddTask2()" v-if="scope.$index == youqinglist.length - 1"></el-button>
</template>
          </el-table-column>
        </el-table>
