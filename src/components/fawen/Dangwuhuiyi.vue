<template>
  <div class="dangwuhuiyidangwuhuiyi">
    <!--面包屑-->
    <el-row>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb>
          ...
          <el-breadcrumb-item>党务会议发文</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
    <!--list-->
    <div v-if="xianshi">
      <div class="dayin">
        ...
        <el-button type="primary" v-print="'#dangwuhuiyi'">打印</el-button>
      ...
      <el-row class="dangwuhuiyi" id="dangwuhuiyi">
        <div class="bantou">中共广西铁路旅游传媒集团有限责任公司委员会会议纪要发文稿纸</div>
        <div class="riqi">
          日期：
          <el-date-picker
            v-if="xiugai"
