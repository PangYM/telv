        ...
        <div class="kuang">
          ...
          <div class="kuang2">
            ...
            <div class="kuang22">
              ...
              <li
                v-bind="form.falvlingdaolist"
                v-for="item in form.falvlingdaolist"
                :key="item.name"
              >
                <a style="color:#000000">{{item.name}} {{item.time}} {{item.yijian}}</a>
              </li>
          ...
          <div class="kuang3" v-if="pishi">
            ...
            <div class="biaoti">
              <el-input size="small" v-model="lingdaopishi" placeholder></el-input>
            </div>
          </div>
          <div class="kuang3">
          ...
          <div class="kuang4">
            ...
            <div class="zhusong">
              <el-input
                ...
                type="textarea"
                rows="3"
                v-model="form.nibanyijian.yijian"
                placeholder
              ></el-input>
              <a
                v-else
...
export default {
  ...
  destroyed() {
    if (this.tongzhi) {
      API.tongzhidongyun({ wendangid: this.form.wendangid, token: localStorage.getItem('token') }).then();
    }
  },
  mounted() {
