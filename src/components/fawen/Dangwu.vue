  ...
  <div class="dangwudangwu">
    ...
    <el-row>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb>
          ...
          <el-breadcrumb-item>党务发文</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
    <!--list-->
    <div v-if="xianshi">
      <div class="dayin">
        ...
        <el-button type="primary" v-print="'#dangwu'">打印</el-button>
      ...
      <el-row class="dangwu" id="dangwu">
        <div class="bantou">
          中共广西铁路旅游传媒集团有限责任公司委员会(
          <el-input v-if="xiugai" class="leixing" size="medium" v-model="form.leixing" placeholder></el-input>
          <a v-else style="color:#000000">{{form.leixing}}</a> )发文稿纸
        </div>
        <div class="riqi">
          日期：
        ...
        <div class="kuang">
          ...
          <div class="kuang2">
            ...
            <div class="kuang22">
              <div class="qianmingtou">合法性审查：</div>
              <li v-bind="form.falvlingdaolist" v-for="item in form.falvlingdaolist" :key="item.name">
                <a style="color:#000000">{{item.name}} {{item.time}} {{item.yijian}}</a>
              </li>
            </div>
          </div>
          <div class="kuang3" v-if="pishi">
            ...
            <div class="biaoti">
              <el-input type="textarea" :autosize="true" v-model="lingdaopishi" placeholder></el-input>
            </div>
          </div>
          <div class="kuang3">
          ...
          <div class="kuang4">
            <div class="kuang41">抄送</div>
            <div class="zhusong">
              <el-input v-if="xiugai" type="textarea" :autosize="true" v-model="form.chaosong" placeholder></el-input>
