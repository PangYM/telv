        ...
        <div class="kuang">
          ...
          <div class="kuang1">
            ...
            <div class="kuang12">
              ...
              <el-input class="neirong" v-if="pishi>2" type="textarea" :autosize="true" v-model="cailiao" placeholder></el-input>
            </div>
          </div>
          <div class="kuang1">
            <div class="kuang11">
            ...
            <div class="kuang12">
              ...
              <el-input class="neirong" v-if="pishi>2" type="textarea" :autosize="true" v-model="caiwu" placeholder></el-input>
            </div>
          </div>
          <div class="kuang1">
            <div class="kuang11">
