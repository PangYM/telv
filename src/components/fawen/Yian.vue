    ...
    <div v-if="xianshi">
      ...
      <el-row class="baogao" id="baogao">
        ...
        <div class="riqi">
          ...
          <a v-else style="color:#000000">{{form.riqi}}</a> 编号：（
          <el-input v-if="xiugai" class="bianhao" size="small" v-model="form.bianhao" placeholder></el-input>）号
        </div>
        <div class="kuang">
          <div class="kuang1">
          ...
          <div class="kuang1">
            <div class="kuang11">内容</div>
            <div class="neirong">
              <el-input v-if="xiugai" type="textarea" :autosize="true" v-model="form.neirong" placeholder></el-input>
              <a v-else style="color:#000000">{{form.neirong}}</a>
            </div>
          </div>
          <div class="kuang3">
            <div class="kuang30">主办单位</div>
            <div class="biaoti">
              <el-input v-if="xiugai" type="textarea" :autosize="true" v-model="form.zhubandanwei" placeholder></el-input>
              <a v-else style="color:#000000">{{form.zhubandanwei}}</a>
            </div>
          </div>
          <div class="kuang3">
            <div class="kuang30">负责人签名</div>
            <div class="biaoti">
              <div v-if="form.lingdao.name">
                <a style="color:#000000">{{form.lingdao.name}} {{form.lingdao.time}}</a>
              </div>
            </div>
          </div>
          <div class="kuang3">
