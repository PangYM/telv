        ...
        <el-col :span="23">
          <el-form ref="form" label-width="120px">
            ...
            <el-form-item label="任务及负责人">
              <el-table :data="form.tasks" border stripe style="width: 100%">
                <el-table-column prop="title" align="center" label="任务描述">
                ...
                <el-table-column prop="puser" label="责任人" align="center" width="300">
<template slot-scope="scope">
  <el-input v-if="xiugai" v-model="scope.row.puser" placeholder="请输入责任人">
  </el-input>
  <div v-else class="xianshi">{{scope.row.puser}}</div>
</template>
                </el-table-column>
                <el-table-column v-if="xiugai" label="操作" align="center" width="60">
<template slot-scope="scope">
  <el-button size="small" icon="el-icon-plus" @click="handleAddTask" v-if="scope.$index == form.tasks.length - 1" :disabled="form.tasks.length == 10 || !(scope.row.title && scope.row.puser)">
  </el-button>
