<template>
  <div class="oa_main">
    ...
    <el-table border :data="qiefendataTable" stripe style="width: 100%" :default-sort = "{prop: 'starttime', order: 'descending'}">
      ...
      <el-table-column sortable prop="nigaoren" align="center" label="发起人" show-overflow-tooltip width="108">
      </el-table-column>
      <el-table-column sortable prop="starttime" align="center" label="发送时间" show-overflow-tooltip width="108">
      </el-table-column>
      <el-table-column sortable prop="jinji" align="center" label="公开类型" show-overflow-tooltip width="108">
      </el-table-column>
