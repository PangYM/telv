        ...
        <div class="hd">
          <div class="right clearfix">
            <div class="action-wrap">
              <div
                @click="changeShowMode('list')"
                class="action-item"
                :class="{act:showMode=='list'}"
              >
            ...
            <div class="action-wrap">
              <div
                @click="changeShowMode('thumb')"
                class="action-item"
                :class="{act:showMode=='thumb'}"
              >
          ...
          <ul class="breadcrumb clearfix">
            <a @click="xuanze(0)" href="#/bangongguanli/bumenwenjian">
              全部
              <i class="icon icon-bread-next"></i>
            </a>
            <li v-bind="selectedOptions1" v-for="(item,index) in selectedOptions1">
              <a
                @click="xuanze(index+1)"
                v-if="index<selectedOptions1.length-1"
                href="#/bangongguanli/bumenwenjian"
              >
                {{item.label}}
                <i class="icon icon-bread-next"></i>
              </a>
          ...
          <div v-if="showMode == 'thumb'" class="list-item-wrap list-item-wrap-thumb">
            ...
            <ul class="list-item clearfix">
              <li v-bind="this.files" v-for="file of otherFiles" class="figure-list-item">
                <div
                  @click="select(file.label)"
                  @dblclick="querendakai(file)"
                  class="figure-list-item-inner"
                >
          ...
          <div v-else class="list-item-wrap list-item-wrap-list clearfix">
            <div v-bind="this.files" class="row clearfix" v-for="file of folderFiles">
              ...
              <div
                @click="select(file.label)"
                @dblclick="querendakai(file)"
                class="col col-border name"
              >
                <i class="icon checkbox icon-nor-m"></i>
                {{file.label}}
              </div>
            </div>
...
.list-item-wrap-thumb .list-item .item.cur,
.list-item-wrap-thumb .list-item .item:hover {
  background-color: rgb(244, 244, 244);
}
...
.list-item-wrap-thumb .list-item .item.cur .checkbox,
.list-item-wrap-thumb .list-item .item:hover .checkbox {
  display: inline-block;
}
/*figure-item*/
...
.list-item-wrap-thumb .figure-list-item:hover,
.list-item-wrap-thumb .figure-list-item.cur {
  background-color: rgb(244, 244, 244);
}
...
.list-item-wrap-list .row.cur .checkbox-wrap .checkbox,
.list-item-wrap-list .row:hover .checkbox-wrap .checkbox {
  display: inline-block;
}
